...
{
    name={SoDa},
    description={SoDa beschreibt ein Scrum basiertes Projekt- und Vorgehensmodell für die Forschung und Industrie.},
    long={Software Development Agile (SoDa)}
}
\newglossaryentry{bzw.}
{
    name={bzw.},
...
{
    name={CSV},
    description={CSV steht für Comma Separated Values und beschreibt ein Dateiformat, wobei die Daten Kommasepariert sind.}
}
\newglossaryentry{z.B.}
{
    name={z.B.},
...
{
    name={JSON},
    description={Die Abkürzung JSON steht für JavaScript Object Notation und beschreibt ein Datenaustauschformat.}
}
% Deployment
% Discord
% HSLU

...
\subsubsection*{Mircosoft Identity}
...
\subsubsection*{Azure Applikation}

\subsubsection*{Microsoft Graph}

\subsubsection*{Der Mail Service}
...
Dort wird das Gerät auf dem die Applikation läuft, beim Starten einmalig authentifiziert und man erhält ein Acces Token zurück.
Dieses kann nun der Klasse \textbf{GraphServiceClient} übergeben werden.
Der GraphServiceClient ist Teil von Microsoft Graph und erlaubt es nun über Ihre API Endpunkte aufzurufen.
...
\newpage
\subsection{Sprint 5}
Im letzten Sprint wird der Bot startbereit gemacht, um ihn auf die produktive Umgebung zu deployen.
Des weiteren erhält er ein Profilbild, welches ihn als Bot zu erkennen gibt.

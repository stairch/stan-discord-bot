...
Diese Änderungen werden im Verlauf von 5 Sprints nach der Software-Development-Agile (SoDa) Methode implementiert.\\
...
Der Text- und Sprach Messenger erfreute sich schnell grosser Beliebtheit und geriet so in das Blickfeld grösserer Investoren wie z.B. Warner Media, die den Dienst 2016 mit rund 20 Millionen US-Dollar unterstützte. \autocite{noauthor_warner_2022} .
...
Für dieses Projekt wird SoDa (Software Development Agile) verwendet. 
...
In SoDa ist es normal, bei jedem Phasenwechsel einen Meilenstein zu definieren und in der Mitte der Realisierungsphase ebenfalls einen. \autocite{jenny_projektmanagement_2016} % PMB Projektplanung p23-25
...
Die Sprache wird an der Hochschule nicht breit verwendet, es gibt jedoch ein Modul zu C\#\autocite{} \todo{PDF source is not in Zotero export} und die Sprache ist ähnlich zu Java, welche grundsätzlich an der Hochschule verwendet wird.
...
Der richtige Studierende, bzw. seine Daten, haben mit dieser Zuteilung nichts zu tun.\\
...
Die Studierenden werden über ein vordefiniertes CSV File geladen. 
...
Nach dieser Zeilstellung sind wir diese Arbeit angegenagen.\\
In einer ersten Phase wurden Ideen und Konzepte zum Stand der Technik, sowie Methoden zur Projektdurchführung ausgearbeitet.
Für dieses Projekt haben wir uns verstärkt mit den Sprach- und Text Messangern auf dem Markt auseinander gesetzt und diese Discord gegenüber gestellt.
...
Allerdings gab es uns die Möglichkeit andere Plattformen anzuschauen und diese vielleicht in zukünftige Umgestaltungen einzubeziehen.\\
Für die Projektmethode wurde, die an der Hochschul praktizierte Softwareentwicklungsmethode, SoDa ausgewählt.
...
In der Realisierungsphase wurden

In der Arbeit wurde neue

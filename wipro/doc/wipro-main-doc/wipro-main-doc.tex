...
Ein genauerer Beschrieb dazu ist im Kapitel \ref{SoDa} auf Seite \pageref{SoDa} zu finden. 
...
Diese Tests werden nach dem AAA-Pattern "Arrange, Act, Assert" erstellt und ausgeführt. \autocite{} % AAA Pattern
...
\begin{itemize}
    ...
    \item Github Story-Board
    \item Sprintreviews (Anhang)
\end{itemize}

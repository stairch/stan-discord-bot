...
\subsubsection*{Ablauf Authentifizierung}
\todo{Nicolas}
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{img/Authentifizierungsprozess_Bot_alt.png}
...
Dieses Event unterilt noch nicht ob es sich um eine allgemeine Nachricht im Chat handelt, 
...
Dort wird eine Vorselektion gemacht, ob es sich bei den eintreffenden Nachrichten um System Messages handlet, oder um andere Bot Nachrichten.
...
\begin{enumerate}
    ...
    \item Installiere .NET 6
        ...
        \end{verbatim}
    \item Lade den Code auf den Server \todo{complete tutorial}
        \begin{verbatim}
            # 
        \end{verbatim}
    \item Erstelle die Datenbank
        \begin{verbatim}
            # 
        \end{verbatim}
    \item Starte die Software \todo{complete tutorial}
        \begin{verbatim}
            # sudo apt update
            # sudo apt upgrade -y
        \end{verbatim}

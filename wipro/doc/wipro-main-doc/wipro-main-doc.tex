...
% https://www.ionos.de/digitalguide/server/knowhow/discord-alternative/
\subsubsection*{Slack}
...
% https://learn.microsoft.com/de-de/dotnet/core/tutorials/testing-with-cli
...
% https://learn.microsoft.com/de-de/dotnet/api/microsoft.extensions.hosting.systemdhostbuilderextensions.usesystemd?view=dotnet-plat-ext-3.1
